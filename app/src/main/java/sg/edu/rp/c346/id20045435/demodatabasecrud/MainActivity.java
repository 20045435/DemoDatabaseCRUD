package sg.edu.rp.c346.id20045435.demodatabasecrud;
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (inserted_id != -1){
                    ...
                    Toast.makeText(MainActivity.this, getString(R.string.insert_successful), Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                al.addAll(dbh.getAllNotes());
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra(getString(R.string.data), target);
                startActivity(i);
            }
        });
    }
